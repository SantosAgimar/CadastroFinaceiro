...
class Cadastro
{
 ...
 public void salvarCadastro()
 {
  ...
  {
   file = "arquivo.txt";
   using (StreamWriter salvarCadastro = new StreamWriter(file, true))
   {
    foreach (Cadastro cadastro in cadastros)
    {
     salvarCadastro.WriteLine($"{cadastro.Data} ");
     salvarCadastro.WriteLine($"ID: {cadastro.Id} ");
     salvarCadastro.WriteLine($"Nome: {cadastro.Nome} ");
     salvarCadastro.WriteLine($"Rg: {cadastro.Rg} ");
     salvarCadastro.WriteLine($"Cpf: {cadastro.Cpf} ");
     salvarCadastro.WriteLine($"Telefone: {cadastro.Telefone} ");
     salvarCadastro.WriteLine($"Endereco: {cadastro.Endereco} ");
     salvarCadastro.WriteLine($"Email: {cadastro.Email} ");
     salvarCadastro.WriteLine($"Tipo: {cadastro.Tipo} ");
    }
   }
